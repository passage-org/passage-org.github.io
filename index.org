...
- [[file:doc/passage-backends.org::#contributing][Support for backends]];
- [[file:doc/passage-engine.org::#contributing][Additional SPARQL operators]].

** SPARQL Operators

For a start, we focused on a subset of SPARQL operators: core SPARQL
[3]. It comprises triple patterns, basic graph patterns, joins,
