...
#+ATTR_HTML: :class feature_cards_1 feature_cards
- {{{OPEN}}} Open :: Built using open source technologies. Available under open licensing.

#+ATTR_HTML: :class feature_cards_2 feature_cards
- {{{COMPLETE}}} Satisfying :: Tired of the frustration of waiting for
...
#+ATTR_HTML: :class feature_cards_3 feature_cards
- {{{FAST}}} Fast :: Leverage powerful knowledge graph backends.
